        ...
        <div v-else class="categories-container">
          ...
          <footer class="page-footer" hidden="true">
            ...
            <div class="footer-bottom">
              <p>&copy; {{ new Date().getFullYear() }} 吾爱导航 - 由 <a href="https://link.985111.xyz/" target="_blank" rel="noopener noreferrer">吾爱导航</a> 用 ❤️ 制作</p>
              <p class="footer-tech">基于 Vue.js 构建 | <a href="https://link.985111.xyz/" target="_blank" rel="noopener noreferrer">查看源代码</a></p>
            </div>
          </footer>
        </div>
      </div>
